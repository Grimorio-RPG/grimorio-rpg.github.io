...
const BASE: Verbete[] = [
  V(
    ...
    ['sintoniza', 'sintonizar', 'sintonizado', 'sintonizados', 'sintonização', 'requer sintonia',
      'attunement', 'attuned', 'requires attunement'],
    'DMG, itens mágicos',
  ),
  V(
    'descanso-curto',
  ...
  V(
    ...
    ['dado de vida', 'hit point die', 'hit dice'],
  ),
  V(
    'vantagem',
    'vantagem',
  ...
  V(
    ...
    ['salvaguardas', 'teste de resistência', 'salvamento', 'saving throw', 'saving throws', 'save'],
  ),
  V(
    'cd',
    'CD',
    ...
    ['classe de dificuldade', 'dc', 'difficulty class'],
  ),
  V(
    'ca',
    'CA',
    ...
    ['classe de armadura', 'ac', 'armor class'],
  ),
  V(
    ...
    ['proficiência', 'proficiente', 'proficiency bonus', 'proficiency'],
  ),
  V(
    'concentracao',
    'concentração',
    ...
    ['concentrar', 'concentrando', 'concentration', 'concentrating'],
  ),
  V(
    'resistencia',
    'resistência',
